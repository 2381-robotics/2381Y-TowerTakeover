    ...
    vector<AutoTask>{
        ...
        AutoTask::SyncTask(
            [](void) -> void {
                intake->Set_Intake(200);
                // 3050
                robot->drive->Set_Point_Drive(95, 0, 2600, 0, 2, 0.5, true, 400, 1, {0, 0, 0, 0});
            },
            [](void) -> bool { return (!robot->drive->get_running()); }, [](void) -> void { robot->drive->Reset_Point(); }, [](void) -> void { intake->Stop(); }),
        ...
        AutoTask::SyncTask(
            [](void) -> void {
                intake->Set_Intake(80);
                // 2150
                robot->drive->Set_Point_Drive(127, 200, 2100, 0, 1, 1, true, 400, 1, {-100, 0, 0, 0});
            },
            [](void) -> bool { return (!robot->drive->get_running()); }, [](void) -> void { robot->drive->Reset_Point(); }, [](void) -> void { intake->Stop(); }),
        ...
        AutoTask::SyncTask(
            [](void) -> void {
                intake->Set_Intake(200);
                robot->drive->Set_Point_Drive(70, 0, 3050, 0, 2, 100, false, 2600, 1, {0, 0, 0, 0});
            },
            [](void) -> bool { return (!robot->drive->get_running()); }, [](void) -> void { robot->drive->Reset_Point(); }, [](void) -> void { robot->drive->Stop(); }),
        // extend angler a bit
        ...
        AutoTask::SyncTask(
            [](void) -> void {
                intake->Set_Intake(60);
                robot->drive->Set_Point_Drive(127, 180, 3500, 0, 2, 1, false, 1050, 1, {0, 0, 0, 0});
            },
            [](void) -> bool { return (!robot->drive->get_running()); }, [](void) -> void { robot->drive->Reset_Point(); }, [](void) -> void { intake->Stop(); }),
        AutoTask::SyncTask(
            [](void) -> void {
                intake->Set_Intake(-1);
                robot->drive->Set_Point_Drive(50, -90, 1400, -127, 2, 2, false, 1000, 1, {0, 0, 0, 0});
            },
            [](void) -> bool { return (!robot->drive->get_running()); }, [](void) -> void { robot->drive->Reset_Point(); }, [](void) -> void { intake->Stop(); }),
        AutoTask::SyncTask(
            [](void) -> void {
                ...
                robot->drive->Set_Point_Drive(50, 0, 1000, 0, 2, 2, false, 400, 1, {0, 0, 0, 0});
            },
            [](void) -> bool { return (!robot->drive->get_running()); }, [](void) -> void { robot->drive->Reset_Point(); }, [](void) -> void { intake->Stop(); }),
        StackTask(),
