...
class AutoTask {
    ...
    static AutoTask AutoDelay(int interval, bool sync = false, std::function<void(void)> task = [](void) -> void {}, std::function<void(void)> init = [](void) -> void {}, std::function<void(void)> kill = [](void) -> void {});
