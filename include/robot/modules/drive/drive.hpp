...
public:
  ...
  virtual void Set_Point_Drive(double speed, double direction, double distance, double turnSpeed, double accelScaling, bool blocking, double criticalPoint, double criticalMultiplier, std::array<double,4> endVelo ) = 0;
